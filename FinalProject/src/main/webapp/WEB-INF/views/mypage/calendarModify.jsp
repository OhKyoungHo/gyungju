              ...
              <div class="left-sidebar">
                ...
                >
                  ...
                  <li class="nav-item">
                    ...
                    >
                      <i class="fas fa-fw fa-pencil"></i> <span>스케쥴</span>
                    </a>
                    <div
                      id="collapseFive"
                      class="collapse"
                    ...
                    >
                      <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="mypage/calendarRegister">스케쥴등록</a><br />
                        <a class="collapse-item" href="mypage/calendarModify">스케쥴 변경</a><br />
                      </div>
                    </div>
                  </li>
