...
<html class="no-js" lang="zxx">
   ...
   <body>
      ...
      <main>
         ...
         <section class="page__title-area page__title-height-2 page__title-overlay d-flex align-items-center" data-background="{/assets/img/page-title/page-title-3.png}">
               ...
               <div class="row">
                  <div class="col-xxl-10 col-xl-10 col-lg-10 ">
                     <div class="page__title-wrapper mt-110">
                        <h3 class="page__title-2">${news.newsTitle}</h3> 
